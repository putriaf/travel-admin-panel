...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Confiavel</b> Travel</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <?php
          ...
          if ($_SESSION['admin']){
            ...
            $username = $_SESSION['kasir'];
          }

          $sql_user = $koneksi->query("select * from tb_akun where id_akun='$username'");
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Anda Login Sebagai
                  <small><?php echo $data_user['level']?></small>
                </p>
              </li>
              <!-- Menu Body -->
